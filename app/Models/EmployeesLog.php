 ...
 * @property int $personal_mobile_no1
 * @property int $mobile2_country_id
 * @property int $personal_mobile_no2
 ...
 * @property int $employee_info_form__url_status
...
class EmployeesLog extends Eloquent
{
	...
	protected $casts = [
		...
		'employee_info_form__url_status' => 'int',
		'created_by' => 'int',
		'record_type' => 'int',
	...
	protected $fillable = [
		...
		'employee_info_form__url_status',
		'created_date',
		'created_by',
		'created_IP',
		'created_browser',
