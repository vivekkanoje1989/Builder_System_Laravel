...
<div class="row" ng-controller="bloodsGroupCtrl" ng-init="manageBloodGroup()">  
                            ...
                            <tr>
                                ...
                                <th style="width: 30%" >
                                    <a href="javascript:void(0);" ng-click="orderByField('blood_group')">Blood Group
                                        <span ><img ng-hide="(sortKey == 'blood_group' && (reverseSort == true || reverseSort == false))" src="../images/sort_both.png"></img></span>
                        ...
                        <tbody ng-controller="adminController">
                            <tr role="row" dir-paginate="list in bloodGrpRow | filter:search | filter:searchData | itemsPerPage: itemsPerPage | orderBy:sortKey:reverseSort" >
                                ...
                                <td class="">
                                    ...
                                    <span ng-show="deleteBtn == '1'" class="" tooltip-html-unsafe="Delete"><a href="" ng-click="deleteBloodgrp({{list.id}},{{$index}})" class="btn-danger btn-xs"><i class="fa fa-trash-o"></i>Delete</a></span>
                                </td>
                            </tr>
                            <tr>
    ...
    <!-- Modal -->
    <div class="modal fade modal-primary" id="bloodGroupModal" role="dialog" tabindex="-1">    
