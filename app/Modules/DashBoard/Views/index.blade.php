...
<div class="row " ng-controller="dashboardCtrl" ng-init="getEmployees()">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 ">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group multi-sel-div" ng-class="{
                                                    'has-error' : (sbtBtn && (!requestLeave.application_to.$dirty && requestLeave.application_to.$invalid)) && emptyApplication }">
                                        ...
                                        <div class=" col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div ng-controller="DatepickerDemoCtrl" class="form-group" ng-class="{
                                                    'has-error' : sbtBtn && (!requestLeave.from_date.$dirty || requestLeave.from_date.$invalid)}">
                                                    <p class="input-group">
                                        ...
                                        <div class=" col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div ng-controller="DatepickerDemoCtrl" class="form-group" ng-class="{
                                                    'has-error' : sbtBtn && (!requestLeave.to.$dirty || requestLeave.to.$invalid)}">
                                                    <p class="input-group">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group" ng-class="{
                                                'has-error' : sbtBtn && (!requestLeave.req_desc.$dirty && requestLeave.req_desc.$invalid) }">
    ...
    <div class="pleaseWait">
        <h2 class="sending "><i class="fa fa-spinner fa-spin" style="font-size:48px"></i>Mail Sending Please Wait......</h2>
    </div>
</div>
