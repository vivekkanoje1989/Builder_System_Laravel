                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        <thead class="bord-bot">
                            ...
                            <tr>
                                ...
                                <th style="width:35%">
                                     <a href="javascript:void(0);" ng-click="orderByField('name')">Country
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="list in countryRow| filter:search | filter:searchData | itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort">
                                <td>{{ itemsPerPage * (noOfRows - 1) + $index + 1}}</td>      
                                <td>{{list.name}}</td>     
                                <td class="">
                                    <span class="" tooltip-html-unsafe="Edit"  data-toggle="modal" data-target="#countryModal"><a href="javascript:void(0);" ng-click="initialModal({{list}},{{ itemsPerPage}},{{$index}},'{{list.sortname}}',{{list.phonecode}})" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a></span>
                                    <span  ng-show="deleteBtn == '1'"  class="" tooltip-html-unsafe="Delete"><a href="" ng-click="deleteCountry({{list.id}},{{$index}})" class="btn-danger btn-xs"><i class="fa fa-trash-o"></i>Delete</a></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3"  ng-show="(countryRow|filter:search|filter:searchData).length == 0" align="center">Record Not Found</td>   
                            </tr>
                        </tbody>
                    </table>
