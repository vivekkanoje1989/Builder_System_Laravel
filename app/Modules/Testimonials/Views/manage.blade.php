                    ...
                    <div class="DTTT btn-group">
                        <a class="btn btn-default DTTT_button_collection" id="ToolTables_editabledatatable_2" ng-disabled="disableBtn">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                <li>
                                    <a href="" ng-click="manageTestimonialApproveExportToExcel()" ng-shoe="exportDetails== '1'">Export</a>
                                </li>
                            </ul>
                        </a>
                    </div>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="list in ApprovedTestimonialsRow|  filter:search |filter:searchData | itemsPerPage:itemsPerPage |orderBy:sortKey:reverseSort">
                                ...
                                <td class="">
                                     <span class="" tooltip-html-unsafe="Edit Information" ><a href="[[ config('global.backendUrl') ]]#/testimonials/update/{{ list.testimonial_id}}" class="btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a></span>
                            ...
                            <tr>
                                ...
                                <td colspan="6"  ng-show="totalCount == 0" align="center">Record Not Found</td>   
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            <input type="text" ng-model="searchDetails.customer_name" capitalizeFirst name="customer_name" class="form-control" oninput="if (/[^A-Za-z]/g.test(this.value)) this.value = this.value.replace(/[^A-Za-z]/g,'')">
                        </span>
                    </div>
                </div>
                <div class="col-sm-12 col-xs-12">
                ...
                <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label class="helpContent">- All the testimonial is present in the website are available here to edit and change.  </label>
                            </div>                            
                        </div>
                    </div>  
            </div>
