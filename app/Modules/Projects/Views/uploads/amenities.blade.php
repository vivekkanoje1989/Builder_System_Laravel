<div class="row">
    <form role="form" name="amenitiesForm" ng-submit="uploadsData(projectData.prid, projectImages, amenityData)">
        ...
        <div class="col-lg-12 col-sm-12 col-xs-12">
            ...
            <div class="col-sm-12 col-xs-12" ng-show="amenities_images">
                <div class="img-div2" data-title="name" ng-repeat="list in amenities_images" id="del_amenities_images_{{$index}}">    
                    <i class="fa fa-times rem-icon"  title="" ng-click="deleteImage({{amenities_images}},'{{list}}', {{$index}}, {{projectData.prid}}, 'project/amenities_images/', 'amenities_images')"></i>
                    <img ng-src="[[ config('global.s3Path') ]]/project/amenities_images/{{list}}" class="thumb photoPreview">
                </div>
