                ...
                <div class="row">
                    <div class="col-sm-8 col-xs-12" style="float:left">                        
                        ...
                        <div class="col-sm-2 center">
                            <button type="button" class="btn btn-primary ng-click-active"  data-toggle="modal" data-target="#showFilterModal" ng-click="procName('proc_reassign_enquiries', '', sharedemployee, presalesemployee)">
