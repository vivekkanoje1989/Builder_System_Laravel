            ...
            <div class="widget-body table-responsive">
                ...
                <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <div class="DTTT btn-group">
                        <a class="btn btn-default DTTT_button_print" id="ToolTables_editabledatatable_1" title="View Excel" ng-click="myInboundExportToxls()" ng-show="myInboundExport == '1'">
                            <span>Export</span>
                        </a>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        <thead class="bord-bot">
                            <tr>
                                ...
                                <th style="width: 10%">
                                    <a href="javascript:void(0);" ng-click="orderByField = 'virtual_number'; reverseSort = !reverseSort">Virtual Number
                                        <span ng-show="orderByField == 'virtual_number'">
                                            <span ng-show="!reverseSort">^</span><span ng-show="reverseSort">v</span></span>
                                    </a>
                                </th>
                                <th style="width: 10%">
                                ...
                                <th style="width: 10%">
                                    <a href="javascript:void(0);" ng-click="orderByField = 'employee_name'; reverseSort = !reverseSort">Call Answered By
                        ...
                        <tbody>
                            <tr dir-paginate="inbound in teaminboundList | filter:search | filter:searchData | itemsPerPage: itemsPerPage | orderBy:orderByField:reverseSort"  >
                            ...
                            <tr>   
                                <td colspan="9" ng-if="!teaminboundLength" align="center">Record Not Found</td>   
                            </tr>
                        </tbody>
                    </table><br>
