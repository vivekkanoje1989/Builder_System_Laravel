    ...
    <div class="loginbox bg-white div-log">
        ...
        <form name="loginForm" novalidate ng-submit="loginForm.$valid && login(loginData)" ng-controller="adminController">
            ...
            <div class="loginbox-textbox">
                <input type="text" name="mobile" class="form-control" placeholder="Mobile No." ng-model="loginData.mobile" required/>
            ...
            <div class="loginbox-textbox">
                <input type="password" name="password" class="form-control" placeholder="Password" minlength="6" ng-model="loginData.password" required/>
