...
<div class="row" ng-controller="customercarepresalesController" ng-init="previous('', [[$type]], 1, [[config('global.recordsPerPage')]],3)" >
                        ...
                        <tbody>
                            ...
                            <td width="20%">
                                <div><b>Followup due : </b>
                                    <span ng-if="enquiry.next_followup_date !=null && enquiry.next_followup_date !='00-00-0000'">   {{ enquiry.next_followup_date}} @ {{ enquiry.next_followup_time}}</span> 
                                    <span ng-if="enquiry.next_followup_date ==null || enquiry.next_followup_date =='00-00-0000'"> N/A</span> 
                                </div>                            
                            </td>
                    ...
                    <div class="DTTTFooter">
                        ...
                        <div class="col-sm-6">
                            <div class="dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginate">
                                <dir-pagination-controls class="pagination" on-page-change="pageChanged(newPageNumber,'previous','', [[$type]], newPageNumber, itemsPerPage)" max-size="5" direction-links="true" boundary-links="true" ng-if="enquiriesLength"></dir-pagination-controls>
                            </div>
                        </div>
                    </div>
                </div> 
