                    ...
                    <div id="registration-form">
                        ...
                        <div class="row" >
                            <div class="col-sm-12 col-xs-12" align="right">
                                <button type="submit" class="btn btn-primary" ng-click="step1 = true">{{pageBtn}}</button>
                                <a href="[[ config('global.backendUrl') ]]#/cloudtelephony/index" class="btn btn-primary">Cancel</a>
                            </div>
                        </div>
