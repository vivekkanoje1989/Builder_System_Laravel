                    ...
                    <form novalidate role="form" ng-submit="customAlertForm.$valid && createAlert(customAlertData, [[ !empty($alertId) ?  $alertId : '0' ]])" name="customAlertForm" ng-init="manageAlerts([[ !empty($alertId) ?  $alertId : '0' ]], 'edit')">
                        ...
                        <div class="row col-lg-12 col-sm-12 col-xs-12">                 
                            <div class="col-lg-12 col-sm-6 col-xs-12">
                                <div class="with-header  with-footer col-md-12 col-xs-12 mar-bot30">                                    
                                    ...
                                    <div class="buttons-preview">
                                        <div class="col-md-12 col-xs-12">
                                            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <label><b>Customer related tags :</b></label>
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <label><b>Employee related tags :</b></label>
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <label><b>Company related tags :</b></label>
                                            ...
                                            <div class="form-group col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <label><b>Vehicle related tags :</b></label>
