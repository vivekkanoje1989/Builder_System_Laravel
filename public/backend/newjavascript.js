app.controller('projectController', ['$scope', '$state', 'Data', 'toaster', '$timeout','$stateParams', function ($scope, $state, Data, toaster, $timeout,$stateParams) {
...
app.controller('basicInfoController', ['$scope', 'Data', 'toaster', 'Upload', '$timeout', '$state', '$stateParams', function ($scope, Data, toaster, Upload, $timeout, $state, $stateParams) {
        ...
        $scope.saveBasicInfo = function (projectData, projectImages) {console.log(projectImages);
...
//                    angular.element('.btn-next').trigger('click');
        ...
        {console.log(selectedImg);
            ...
            {
                if (index > -1) {console.log(selectedImg);
                    selectedImg.splice(index, 1);console.log(selectedImg);
