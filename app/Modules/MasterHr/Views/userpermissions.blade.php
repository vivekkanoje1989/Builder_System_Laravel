                                                ...
                                                <ul class="acc-bord" style="list-style-type: none;" >
                                                    <li ng-if='parent.total_submenu == 1' ng-repeat="child1 in parent.submenu">
                                                        <label>
                                                            ...
                                                            <input class="checkbox-slider slider-icon" type="checkbox" data-level="first" id="child1_{{child1.id}}" ng-checked="{{child1.checked}}" ng-click="accessControl('employee', [[ $empId ]], 'child1_{{child1.id}}', [],[{{child1.id}}],[{{ child1.submenu_ids}}], [],0)">
...
<!--                                                            <input class="checkbox-slider slider-icon" type="checkbox" ng-if='child1.total_submenu == 1' data-level="first" id="child1_{{child1.id}}" ng-checked="{{child1.checked}}" ng-click="accessControl('employee',[[ $empId ]],'child1_{{child1.id}}',[],[{{child1.id}}])">
                                                        ...
                                                        <ul class="acc-bord" style="list-style-type: none;" ng-if='child1.total_submenu == 1'>
                                                            <li ng-repeat="child2 in child1.submenu">
                                                                <label>
                                                                    <input class="checkbox-slider slider-icon" type="checkbox" data-level="second" id="child2_{{child2.id}}" ng-checked="{{child2.checked}}" ng-click="accessControl('employee', [[ $empId ]], 'child2_{{child2.id}}',[{{child1.id}}],[{{child2.id}}],[{{ child1.submenu_ids}}], [{{child2.submenu_ids}}],0)">
                                                        ...
                                                        <ul class="acc-bord" style="list-style-type: none;" ng-if='child1.total_submenu != 1'>    
                                                            <li ng-repeat="child2 in child1.submenu">
                                                                <label>
                                                                    <input class="checkbox-slider slider-icon" type="checkbox" data-level="second" id="child2_{{child2.id}}" data-level="second" ng-checked="{{child2.checked}}" ng-click="accessControl('employee', [[ $empId ]], 'child2_{{child2.id}}',[{{child1.id}}],[{{child2.id}}],[{{ child1.submenu_ids}}], [{{child2.submenu_ids}}],1)">
<!--                                                                    <input class="checkbox-slider slider-icon" type="checkbox" data-level="second" ng-if='child2.total_submenu == 1' id="child2_{{child2.id}}" data-level="second" ng-checked="{{child2.checked}}" ng-click="accessControl('employee',[[ $empId ]],'child2_{{child2.id}}',[{{child1.id}}],[{{child2.id}}])">
                                                                ...
                                                                <ul class="acc-bord" style="list-style-type: none;" ng-if='child2.total_submenu == 1'>    
                                                                    <li ng-repeat="child3 in child2.submenu">
                                                                        <label>
                                                                            <input class="checkbox-slider slider-icon" type="checkbox" data-level="third" id="child3_{{child3.id}}" ng-checked="{{child3.checked}}" data-level="third" ng-click="accessControl('employee', [[ $empId ]], 'child2_{{child3.id}}',[{{child1.id}},{{child2.id}}],[{{child3.id}}],[{{ child1.submenu_ids}}],[{{ child2.submenu_ids}}],0)">
                                                                ...
                                                                <ul class="acc-bord" style="list-style-type: none;" ng-if='child2.total_submenu != 1'> 
                                                                    <li ng-repeat="child3 in child2.submenu">
                                                                        <label>
                                                                            <input class="checkbox-slider slider-icon" type="checkbox" data-level="third" id="child3_{{child3.id}}" data-level="third" ng-checked="{{child3.checked}}" ng-click="accessControl('employee', [[ $empId ]], 'child3_{{child3.id}}',[{{child1.id}},{{child2.id}}],[{{child3.id}}],[{{ child1.submenu_ids}}],[{{ child2.submenu_ids}}],0)">
