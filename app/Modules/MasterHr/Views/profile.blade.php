                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <span class="input-icon icon-right">
                                        <input type="file" ngf-select name="employee_photo_file_name" id="employee_photo_file_name" ng-model-options="{ allowInvalid: true, debounce: 300 }"  ng-model="profileData.employee_photo_file_name" ng-change="checkImageExtension(profileData.employee_photo_file_name);checkImagesize(profileData.employee_photo_file_name)" id="employee_photo_file_name"  accept="image/x-png,image/gif,image/jpeg,image/bmp,image/jpg"    class="form-control imageFile"   ngf-model-invalid="errorFile" required> 
                                        <div ng-show="btnProfile || invalidImage || invalidImagesize"   ng-messages="frmProfile.employee_photo_file_name.$error" class="help-block">
                                                ...
                                                <div ng-if="invalidImagesize" class="sp-err">{{invalidImagesize}}</div>
                                       </div>
                    ...
                    <div id="pricing-form">
                        ...
                        <div class="row" >
                            <div class="col-sm-6" >
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="password" ng-model="profileData.password"  ng-pattern="/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,}/" name="password"  maxlength="15"  ng-minlength="6"  class="form-control" required>
                                        <div ng-show="btnfrmPassword" ng-messages="frmPassword.password.$error" class="help-block">
                                            <div id="err_new_pass_blank" ng-message="required" class="sp-err" >This field is required.</div>
                                            <div id="err_new_pass_minlength" ng-message="minlength" class="sp-err">Minimum 6 and Maximum 15 Characters Allowed.</div>
                                            <div id="err_new_pass_maxlength" ng-message="maxlength" class="sp-err">Maximum 15 Characters Allowed.</div>
                            ...
                            <div class="col-sm-6" >
                                <div class="form-group" >
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="password" ng-model="password_confirmation" name="password_confirmation" maxlength="15"  ng-minlength="6" class="form-control" compare-to="profileData.password" required>
                                        <div ng-show="btnfrmPassword"  ng-messages="frmPassword.password_confirmation.$error" class="help-block">
                                            <div id="err_cof_pass" ng-message="required" class="sp-err">This field is required.</div>
                                            <div id="err_cof_pass_minlength" ng-message="minlength" class="sp-err">Minimum 6 Characters Allowed.</div>
                                            <div id="err_cof_pass_minlength" ng-message="maxlength" class="sp-err">Minimum 15 Characters Allowed.</div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 cl-xs-12" align="center">
                                <br><br> <br>
                                <button type="submit" class="btn btn-primary" id="btn_chang_password" ng-click="btnfrmPassword = true" ng-disabled="changePass">Change Password</button>
                            </div>
                        </div>
                    </div>
                </div>
