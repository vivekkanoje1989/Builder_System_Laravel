    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                ...
                <a href="" data-toggle="modal" data-target="#highesteducModal" ng-click="initialModal(0, '', '')" class="btn btn-primary">Add Highest Education</a>&nbsp;&nbsp;&nbsp;
            ...
            <div class="widget-body table-responsive">     
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in educationRow| filter:search | itemsPerPage:itemsPerPage|orderBy:orderByField:reverseSort">
