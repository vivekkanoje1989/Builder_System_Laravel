                    ...
                    <tbody>
                        ...
                        <tr role="row" ng-repeat="list in departmentRow| filter:search |orderBy:orderByField:reverseSort" ng-class="{'selected':$index == selectedRow}" ng-click="setClickedRow($index)">
                            ...
                            <td>{{ list.department_name}}</td>                          
                             <td class="fa-div">
                                <div class="fa-hover" tooltip-html-unsafe="Edit User" style="display: block;" data-toggle="modal" data-target="#departmentModal"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.department_name}}',$index)"><i class="fa fa-pencil"></i></a></div>
                            </td> 
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="modal-content">
                ...
                <form novalidate ng-submit="departmentForm.$valid && dodepartmentAction()" name="departmentForm">
                    <div class="modal-body">
                        <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!departmentForm.blood_group.$dirty && departmentForm.department_name.$invalid)}">
