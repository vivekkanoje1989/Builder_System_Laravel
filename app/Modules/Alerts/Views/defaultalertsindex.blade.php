                    ...
                    <div class="DTTT btn-group">
                        <a class="btn btn-default DTTT_button_collection" id="ToolTables_editabledatatable_2">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                <li>
                                    <a href="" ng-click="defaultTemplatesExportToxls();" ng-show="exportData == '1'">Export</a>
                                </li>
                            </ul>
                        </a>
                    </div>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="listAlert in listdefaultAlerts | filter:search  | filter:searchData | itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort" id='{{listAlert.id}}'>
                                ...
                                <td class="">
                                    <span class="" tooltip-html-unsafe="view template" ><a href="[[ config('global.backendUrl') ]]#/defaultalerts/update/{{ listAlert.id}}" class="btn-primary btn-xs"><i class="fa fa-eye"></i>View</a> &nbsp;&nbsp;</span>
