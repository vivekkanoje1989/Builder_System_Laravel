    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                ...
                <a data-toggle="modal" data-target="#projecttypesModal" ng-click="initialModal(0, '', '')" class="btn btn-primary">Add Project Types</a>&nbsp;&nbsp;&nbsp;
            ...
            <div class="widget-body table-responsive">  
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in ProjectTypesRow| filter:search | orderBy:orderByField:reverseSort | itemsPerPage:itemsPerPage">
