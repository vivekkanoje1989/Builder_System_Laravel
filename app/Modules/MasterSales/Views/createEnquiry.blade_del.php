                    ...
                    <div class="col-sm-3 col-md-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="form-group" ng-controller="DatepickerDemoCtrl">
                                <p class="input-group">
                                    <input type="text"  ng-model="enquiryData.sales_enquiry_date" name="sales_enquiry_date" class="form-control" datepicker-popup="{{format}}" is-open="opened" max-date=maxDate datepicker-options="dateOptions" close-text="Close" ng-click="toggleMin()" readonly>
                            ...
                            </div>{{ enquiryData.sales_enquiry_date }} rrrrr
                        </div>
                    </div>
                    <div class="col-sm-3 col-md-3 col-xs-12">
