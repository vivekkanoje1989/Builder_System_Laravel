    ...
    <div class="mainDiv col-xs-12 col-md-12">
        <div class="widget flat radius-bordered">
            <div class="widget-header bordered-bottom bordered-themeprimary">
                <span class="widget-caption">Approve Testimonials</span>        
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="list in ApprovedTestimonialsRow|  filter:search |filter:searchData  | itemsPerPage:itemsPerPage |orderBy:sortKey:reverseSort">
                                ...
                                <td class="">
                                   <span class="" tooltip-html-unsafe="Edit" ><a href="[[ config('global.backendUrl') ]]#/testimonials-manage/update/{{ list.testimonial_id}}" class="btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a></span>
                ...
                <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label class="helpContent">- The all received testimonials from website are comes here and
pending for approval from authorised user. </label>
                            </div>                            
                        </div>
                    </div>  
            </div>
