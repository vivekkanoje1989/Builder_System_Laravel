                    ...
                    <li>
                        <a class="login-area dropdown-toggle" data-toggle="dropdown" ng-init="profilefun()">{{profileImage}}
                            <div class="avatar" title="View your public profile">
                                ...
                                <?php } else { ?>
                                    <img  src="/backend/images/user-1.png"  >
                                <?php } ?>
                            </div>
                            <section>
                        ...
                        <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                            ...
                            <li>
                                <div class="avatar-area">
                                    <?php if (Auth::guard('admin')->user()->employee_photo_file_name != '') { ?>
                                        <img  src="[[ config('global.s3Path').'/employee-photos/'.Auth::guard('admin')->user()->employee_photo_file_name;]]" style="width:128px;">
                                    <?php } else { ?>
                                        <img  src="/backend/images/user-1.png" style="width:128px;" >
                                    <?php } ?>
    <!--                                     <img ng-show="[[Auth::guard('admin')->user()->employee_photo_file_name]]!=''" ng-src="[[ config('global.s3Path').'/employee-photos/'.Auth::guard('admin')->user()->employee_photo_file_name;]]">
                                    <img ng-show="[[Auth::guard('admin')->user()->employee_photo_file_name]]==''" ng-src="/backend/images/user-1.png" style="width: 128px;" >
                                    </div>-->
                                    </li>
                                    <!--Avatar Area-->
                                    <li class="edit">
