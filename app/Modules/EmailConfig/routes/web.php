...
Route::group(array('module' => 'EmailConfig', 'middleware' => ['auth:admin'], 'namespace' => 'App\Modules\EmailConfig\Controllers'), function() {
    ...
    Route::get('/email-config/configEmailExportToxls', 'EmailConfigController@configEmailExportToxls');
    ...
    Route::post('/email-config/deleteEmailConfig', 'EmailConfigController@deleteEmailConfig');
