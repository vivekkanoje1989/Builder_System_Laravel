            ...
            <div class="modal-content">
                ...
                <form novalidate ng-submit="lostReasonForm.$valid && doLostReasonsAction()" name="lostReasonForm">
                    <div class="modal-body">
                        <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!lostReasonForm.reason.$dirty && lostReasonForm.reason.$invalid) && (!lostReasonForm.status.$dirty && lostReasonForm.lost_reason_status.$invalid)}">
                            ...
                            <br/><br/>
                            <span class="input-icon icon-right">
                                <select class="form-control" ng-model="lost_reason_status" name="lost_reason_status" required>
