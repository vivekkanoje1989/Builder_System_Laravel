        ...
        <div class="col-lg-6 col-md-6 col-xs-12">
            <div class="widget flat radius-bordered">
                ...
                <div class="widget-body">
                    <form  ng-submit="requestLeave.$valid && request.application_to.length != '' && request.application_to.length != null && doOtherApprovalAction(request, '2')" name="requestLeave"  novalidate>
