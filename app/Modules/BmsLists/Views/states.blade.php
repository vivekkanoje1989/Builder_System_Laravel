<div class="row" ng-controller="statesCtrl" ng-init="manageStates()">  
 <div>
                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        <tr role="row" dir-paginate="list in statesRow| filter:search | itemsPerPage:itemsPerPage | orderBy:orderByField:reverseSort">
                            ...
                            <td>{{list.name}}</td>                          
                            <td class="fa-div">
                                <div class="fa-hover" tooltip-html-unsafe="Edit User" style="display: block;" data-toggle="modal" data-target="#statesModal"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.name}}','{{list.country_name}}',{{ itemsPerPage}},{{$index}})"><i class="fa fa-pencil"></i></a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
