            ...
            <div class="widget-body table-responsive">                
                ...
                <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    ...
                    <div  class="dataTables_filter">                        
                        ...
                        <label ng-if="type == 0" style="left:2%"><input class="checkbox-slider slider-icon colored-primary" type="checkbox" id="statuschk1" ng-model="sharedemployee" checked="" ng-click="pendingsFollowups('', [[$type]], 1, [[config('global.recordsPerPage')]], 5, sharedemployee)"><span  class="text">&nbsp;&nbsp;Shared Enquiries of Employees</span></label>                    
                    </div>
                    <!-- filter data--> 
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader">
                        ...
                        <td width="13%">
                            ...
                            <hr class="enq-hr-line">
                            <div>
                                <a href data-toggle="modal" data-target="#todayremarkDataModal" ng-click="getTodayRemark({{enquiry.id}},'',sharedemployee)"><i class="fa fa-external-link" aria-hidden="true"></i>&nbsp;Todays Remark</a><br/>
                    ...
                    <div class="DTTTFooter">
                        ...
                        <div class="col-sm-6">
                            <div class="dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginate">
                                <dir-pagination-controls class="pagination" on-page-change="pageChanged(newPageNumber,'pendingsFollowups','', [[$type]],newPageNumber,listType,sharedemployee)" max-size="5" direction-links="true" boundary-links="true" ng-if="enquiriesLength"></dir-pagination-controls>
                            </div>
                        </div>
                    </div>               
                </div>
