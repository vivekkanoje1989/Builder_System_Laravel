...
//        console.log($scope.popupData);
      ...
      /* Uma  */
    $scope.getProjectInventory =function(id)
    {
        Data.post('projects/getProjectInventory',{data: {projectId: $scope.projectData.project_id,wingId:id}}).then(function (response) {
            if (!response.success) {
               $scope.errorMsg = response.message;
            } else {
