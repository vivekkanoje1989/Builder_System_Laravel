        ...
        <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-sm-3 col-xs-6" ng-if="enqType != 1">
                        <div class="form-group" ng-class="{ 'has-error' : enqFormBtn && (!enquiryForm.min_budget.$dirty && enquiryForm.min_budget.$invalid)}">
                            ...
                            <span class="input-icon icon-right">
                                ...
                                <i class="fa fa-sort-desc"></i>
                                <div ng-show="enqFormBtn" ng-messages="enquiryForm.min_budget.$error" class="help-block enqFormBtn">
                                    <div ng-message="required">This field is required</div>
                                </div>
                                <div ng-if="min_budget" class="sp-err blog_title">{{ min_budget }}</div>
                            </span>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6" ng-if="enqType != 1">
                        <div class="form-group" ng-class="{ 'has-error' : enqFormBtn && (!enquiryForm.max_budget.$dirty && enquiryForm.max_budget.$invalid)}">
                            ...
                            <span class="input-icon icon-right">
                                ...
                                <div ng-if="max_budget" class="sp-err blog_title">{{ max_budget }}</div>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">
                                <select class="form-control" ng-controller="getEmployeesCtrl" ng-model="enquiryData.followup_by_employee_id" name="followup_by_employee_id">
                                    ...
                                    <option ng-repeat="list in employeeList" value="{{list.id}}" ng-selected="{{ list.id == [[ Auth::guard('admin')->user()->id ]] }}" ng-if="enqType != 0 || (enquiryData.id === undefined && enqType == 0 )">{{list.first_name}} {{list.last_name}}</option>
                                    <option ng-repeat="list in employeeList" value="{{list.id}}" ng-selected="list.id == enquiryData.followup_by_employee_id"  ng-if="enqType == 0 && enquiryData.id > 0">{{list.first_name}} {{list.last_name}}</option>
                                </select>
                                <i class="fa fa-sort-desc"></i>
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <div class="form-group" >
                            ...
                            <div ng-controller="DatepickerDemoCtrl" class="form-group" ng-if="enquiryData.id === undefined || enquiryData.id <=0">
                                <p class="input-group">
                                ...
                                <div ng-show="enqFormBtn" ng-messages="enquiryForm.next_followup_date.$error" class="help-block">
                                    <div ng-message="required">This field is required</div>
                                    <!--<div ng-if="enquiryData.next_followup_date < todaydate ">Please select next followup date</div>-->
                                </div>
                                <div ng-if="next_followup_date" class="sp-err blog_title">{{next_followup_date}}</div>
                                </p>
                            </div>
                            <div ng-if="enquiryData.id !== undefined && enquiryData.id > 0">
                                <input type="textbox" ng-model="enquiryData.next_followup_date" name="next_followup_date"  id="next_followup_date" class="form-control" datepicker-popup="dd-M-yyyy" readonly/>                                
                            </div>
                        </div>                        
                    </div>
                    <div class="col-sm-3 col-xs-6">
            ...
            <div class="row" ng-if="enqType != 1">
                <div class="col-lg-12 col-sm-12 col-xs-12">  
                    ...
                    <div class="col-sm-3 col-xs-6" ng-if="enquiryData.finance_required_from == 1 && enquiryData.finance_required_from == 2">
                        <div class="form-group">
            ...
            <div>
                    ...
                    <div class="form-group" ng-class="{ 'has-error' : enqFormBtn && (!enquiryForm.project_id.$dirty && enquiryForm.project_id.$invalid)}">
                        ...
                        <span class="input-icon icon-right">
                            <select ng-controller="projectCtrl" ng-model="enquiryData.project_id" name="project_id"  id ="project_id" class="form-control" ng-change="getBlockTypes(enquiryData.project_id)">
                                ...
                                <option ng-repeat="plist in projectList" value="{{plist.id}}_{{plist.project_name}}" ng-selected="projects_id == plist.id">{{plist.project_name}}</option>
                            </select>
                            <i class="fa fa-sort-desc"></i>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group"><label for=""></label>
                        <span class="input-icon icon-right">
                            <button type="button" ng-if="addProBtnn" class="btn btn-primary" ng-click="addProBtn = true && addProjectRow(enquiryData.project_id)" style="padding: 7px 5px;">Add Project</button>
                            <button type="button" ng-if="editProBtnn" class="btn btn-primary" ng-click="editProjectRow(enquiryData.project_id,enquiryData)" style="padding: 7px 5px;">Edit Project</button>
                        </span> 
                    </div>
                </div>                   
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12" align="center">
                    ...
                    <button class="btn btn-primary" ng-click="backToListing('{{searchData.searchWithMobile}}','{{searchData.searchWithEmail}}','0')">Cancel</button>
                </div>
            </div>
        </div>
    </div>
