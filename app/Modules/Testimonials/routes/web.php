...
Route::group(array('module' => 'Testimonials', 'middleware' => ['auth:admin'],'namespace' => 'App\Modules\Testimonials\Controllers'), function() {
    ...
    Route::post('/testimonials/getApprovedList','TestimonialsController@getApprovedList')->middleware("permission:060303"); //get approved list
    Route::post('/testimonials/getTestimonialData','TestimonialsController@getTestimonialData')->middleware("permission:060301|060303"); //on edit page, get data
    Route::post('/testimonials/deleteDisApprovedList','TestimonialsController@deleteDisApprovedList')->middleware("permission:060301"); 
    Route::post('/testimonials/deleteApprovedList','TestimonialsController@deleteApprovedList')->middleware("permission:060303"); 
    ...
    Route::get('/testimonials/manageTestimonialApproveExportToExcel', 'TestimonialsController@manageTestimonialApproveExportToExcel')->middleware("permission:060303");
    Route::get('/testimonials/{id}/editApproved','TestimonialsController@editApproved')->middleware("permission:060303");//update data on approved list
    ...
    Route::get('/testimonials/manage', 'TestimonialsController@show')->middleware("permission:060303"); //show approved list on manage page
