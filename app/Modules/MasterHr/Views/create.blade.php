                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="input-icon icon-right1">
                                            ...
                                            <div ng-show="step2 || errLandline" ng-messages="userContactForm.personal_landline_no.$error" class="help-block step2 {{applyClass}}">
                                                ...
                                                <div ng-message="maxlength">Landline number must be 12 digits</div>
                            ...
                            <div class="row">  
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group" ng-class="{ 'has-error' : step2 && (!userContactForm.current_address.$dirty && userContactForm.current_address.$invalid)}">
                                        ...
                                        <span class="input-icon icon-right">
                                            <textarea ng-model="userContact.current_address" name="current_address" ng-change="changePermanentAddress()"  ng-disabled="permanentAdd" class="form-control" maxlength="255" required></textarea>
                            ...
                            <div class="row">  
                                <div class="col-sm-6 col-xs-6">
                                    <div class="form-group" ng-class="{ 'has-error' : step2 && (!userContactForm.current_country_id.$dirty && userContactForm.current_country_id.$invalid)}">
                                        ...
                                        <span class="input-icon icon-right">
                                            <select ng-change="onCountryChange(); changePermanentAddress();" ng-model="userContact.current_country_id"  ng-disabled="permanentCountry" name="current_country_id" id="current_country_id" class="form-control" required>
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    <div class="form-group" ng-class="{ 'has-error' : step2 && (!userContactForm.current_state_id.$dirty && userContactForm.current_state_id.$invalid)}">
                                        ...
                                        <span class="input-icon icon-right">
                                            <select ng-model="userContact.current_state_id" ng-change="onStateChange(); changePermanentAddress()"  ng-disabled="permanentState" name="current_state_id" id="current_state_id" class="form-control" required>
                            ...
                            <div class="row">  
                                <div class="col-sm-6 col-xs-6">
                                    ...
                                    <div class="form-group" ng-class="{ 'has-error' : step2 && (!userContactForm.current_city_id.$dirty && userContactForm.current_city_id.$invalid)}">
                                        <span class="input-icon icon-right">
                                            <select ng-model="userContact.current_city_id" ng-change="changePermanentAddress();"  ng-disabled="permanentCity" name="current_city_id" class="form-control" required>
                            ...
                            <div class="form-title">
                                ...
                                <span class="checkbox" style="display:inline-block;margin: 0;">
                                    <label>
                                        ...
                                        <span class="text"> Same as correspondence id</span>
                                    </label>
                                </span>	
                            </div>
                            <div class="row">  
