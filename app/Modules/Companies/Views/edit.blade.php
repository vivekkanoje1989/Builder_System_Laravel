                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form name="stationaryForm"  ng-submit="stationaries(stationary,<?php echo $companyId; ?>)" enctype="multipart/form-data">  
                                <div class="row">
                                    <div class="col-md-6">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <form name="stationaryForm"  ng-submit="documentDetails(documentData, documentData.document_file,<?php echo $companyId; ?>)" enctype="multipart/form-data">  
                                <div class="row">
                                    <div class="col-md-12">
