                        ...
                        <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                            ...
                            <tbody>
                                <tr role="row" dir-paginate="listNumber in ct_employee_extlist | filter:search | filter:searchData | itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort" >
                                    ...
                                    <td class="">
                                        <span class="" tooltip-html-unsafe="Edit" ><a href="javascript:void(0)" data-toggle="modal"  data-target="#addExtensionModal" ng-click="editExtensionModal(ct_employee_extlist, listNumber)" class='btn-primary btn-xs'><i class="fa fa-edit"></i>Edit</a> &nbsp;&nbsp;</span>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5"  ng-show="totalCount == 0" align="center">Record Not Found</td>   
                                </tr>
                            </tbody>
                        </table>
