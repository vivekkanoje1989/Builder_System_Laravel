                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="list in countryRow| filter:search | filter:searchData | itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort">
                                ...
                                <td>{{list.name}}</td>     
                                <td class="">
                                    <span class="" tooltip-html-unsafe="Edit"  data-toggle="modal" data-target="#countryModal"><a href="javascript:void(0);" ng-click="initialModal({{list}},{{ itemsPerPage}},{{$index}},'{{list.sortname}}',{{list.phonecode}})" class="btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a></span>
