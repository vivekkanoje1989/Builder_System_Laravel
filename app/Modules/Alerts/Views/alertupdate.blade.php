            ...
            <div class="widget-body">
                <form novalidate role="form" ng-submit="alertFrom.$valid &&  createAlert(alertData, alertData.image_file,[[ !empty($alertId) ?  $alertId : '0' ]])" name="alertFrom" ng-init="manageAlerts([[ !empty($alertId) ?  $alertId : '0' ]],'edit',[[$customerType]])">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group" >
                                <label for="">SMS Cc Numbers (comma separates multiple numbers)</label>
                                <span class="input-icon icon-right">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label for="">SMS Cc Employees</label>
                                 <span class="input-icon icon-right">
                                    <ui-select multiple ng-model="alertData.sms_cc_employees" name="sms_cc_employees" theme="select2" ng-disabled="disabled" style="width: 370px;" ng-required ng-init="getEmployees()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <span class="input-icon icon-right">
                                    <ui-select multiple ng-model="alertData.email_cc_employees" name="email_cc_employees" theme="select2" ng-disabled="disabled" style="width: 370px;" ng-required ng-change="">
                                        <ui-select-match placeholder="Select Email">{{$item.email}}</ui-select-match>
                                        <ui-select-choices repeat="Employee in Employees | filter:$select.search">
                                            {{Employee.email}} 
                                        </ui-select-choices>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <span class="input-icon icon-right">
                                    <ui-select multiple ng-model="alertData.email_bcc_employees" name="sms_cc_employees" theme="select2" ng-disabled="disabled" style="width: 370px;" ng-required>
                                        <ui-select-match placeholder="Select Email">{{$item.email}}</ui-select-match>
                                        <ui-select-choices repeat="Employee in Employees | filter:$select.search">
                                            {{Employee.email}} 
                                        </ui-select-choices>
