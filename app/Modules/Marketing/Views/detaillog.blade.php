                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        <thead class="bord-bot">
                            <tr>
                                ...
                                <th style="width:8%">
                                    <a href="javascript:void(0);" ng-click="orderByField = 'credits_deducted'; reverseSort = !reverseSort">Credit Deducted
                        ...
                        <tbody>
                            ...
                            <tr role="row" dir-paginate="listSms in smslogslistdetail | filter:search |filter:searchData| itemsPerPage:itemsPerPage | orderBy:orderByField:reverseSort" >
