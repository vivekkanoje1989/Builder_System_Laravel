            ...
            <div class="widget-body table-responsive">
                <div class="row table-toolbar">      
                    <div class="btn-group pull-right filterBtn">
                        <a class="btn btn-default toggleForm" data-target="#showFilterModal" ng-click="procName('proc_cc_presales_total', 4)"><i class="btn-label fa fa-filter"></i>Show Filter</a>
                    </div>
                </div>
