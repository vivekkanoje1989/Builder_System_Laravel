                ...
                <table class="table table-hover table-striped table-bordered" at-config="config">
                    ...
                    <tbody>
                        ...
                        <tr role="row" ng-repeat="list in DiscountHeadingRow| filter:search | orderBy:orderByField:reverseSort" ng-class="{'selected':$index == selectedRow}" ng-click="setClickedRow($index)">
                            ...
                            <td class="fa-div">
                                <div class="fa-hover" tooltip-html-unsafe="Edit Lost Reason" style="display: block;" data-toggle="modal" data-target="#discountheadingModal"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{ list.discount_name}}',{{ list.status}},$index)"><i class="fa fa-pencil"></i></a></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
