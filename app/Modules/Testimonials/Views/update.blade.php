                        ...
                        <div id="registration-form">
                            <form novalidate ng-submit="testimonialsForm.$valid && doTestimonialsAction(photo_url)" name="testimonialsForm"  enctype="multipart/form-data" ng-init="getTestimonialData('<?php echo $testimonialId; ?>')">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-xs-12 ">
                                        <div class="form-group"  style="margin-top:75px;" ng-class="{ 'has-error' : sbtBtn && (!testimonialsForm.approve_status.$dirty && testimonialsForm.approve_status.$invalid) }">
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="form-group" style="margin-top:75px;">
                                            <label>Display on portal <span class="sp-err">*</span></label>
                                            <span class="input-icon icon-right">
