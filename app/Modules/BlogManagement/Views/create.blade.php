                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!blogsForm.title.$dirty && blogsForm.title.$invalid) }">
                                                <span class="input-icon icon-right">
                                                    <input type="text" class="form-control" ng-model="title" capitalizeFirst name="title"  ng-change="errormsg = null" maxlength="255" required>
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            <label>Url</label>
                                            <span class="input-icon icon-right">
                                                <input type="text" class="form-control" ng-model="blog_seo_url"  name="blog_seo_url" maxlength="200">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-12 ">
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon icon-right">
                                                <textarea ng-model="meta_description" capitalizeFirst name="meta_description" class="form-control ng-pristine ng-valid ng-valid-maxlength ng-touched" maxlength="500" required></textarea>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon icon-right">
                                                <textarea ng-model="meta_Keywords" capitalizeFirst name="meta_Keywords" class="form-control ng-pristine ng-valid ng-valid-maxlength ng-touched" maxlength="500" required></textarea>
                                            </span>
                                        </div>
                                    </div>
                                </div>                                  
                                            ...
                                            <span class="input-icon icon-right">
                                                <div class="widget flat radius-bordered">
                                                    ...
                                                    <div class="widget-body no-padding">   
                                                        <div class="form-group">
                                                            <div text-angular name="blog_short_description" ng-model="blog_short_description" ta-text-editor-class="editor-text" ta-html-editor-class="editor-text" maxlength="500" required></div>
                                                        </div>
                                                    </div>
                                                </div> 
                                        ...
                                        <div class="form-group" ng-class="{ 'has-error' : sbtBtn && (!blogsForm.blog_description.$dirty && blogsForm.blog_description.$invalid) }">
                                            <span class="input-icon icon-right">
                                                <div class="widget flat radius-bordered">
                                                    ...
                                                    <div class="widget-body no-padding">   
                                                        <div class="form-group">
                                                            <div text-angular name="blog_description" ng-model="blog_description" ta-text-editor-class="editor-text" ta-html-editor-class="editor-text" maxlength="500" required></div>
                                                        </div>
                                                    </div>
                                                </div> 
