                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon icon-right">
                                                ...
                                                <div ng-show="sbtBtn" ng-messages="customerForm.title_id.$error" class="help-block errMsg">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <span class="input-icon icon-right">
                                                ...
                                                <div ng-show="sbtBtn" ng-messages="customerForm.first_name.$error" class="help-block errMsg">
                    ...
                    <div class="modal-content">
                        ...
                        <form ng-submit="modalForm.$valid && addRow(contactData)" novalidate name="modalForm">
                            ...
                            <div class="modal-footer" align="center">
                                <button type="submit" class="btn btn-sub" ng-disabled="modalForm.$pristine" ng-click="modalSbtBtn=true">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
