            ...
            <div class="widget-body table-responsive">
                ...
                <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <div class="DTTT btn-group">
                        <a class="btn btn-default DTTT_button_collection" id="ToolTables_editabledatatable_2" ng-disabled="disableBtn">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                <li>
                                    <a href="" ng-click="teamOutboundExportToxls()" ng-show="teamOutboundExport == '1'" >Export</a>
                                </li>
                            </ul>
                        </a>
                    </div>
                    <div  class="dataTables_filter">
                        <label>
                            <input type="search" class="form-control input-sm" ng-model="search" ng-disabled="disableBtn" name="search" >
                        </label>
                    </div>
                    <!-- filter data--> 
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr dir-paginate="outbound in teamoutboundList | filter:search  | filter:searchData | itemsPerPage: itemsPerPage | orderBy:sortKey:reverseSort" >
