                ...
                <div class="row">
                    <div class="col-sm-5 col-xs-12" style="float:left">
                        ...
                        <div class="col-sm-4 center">
                            <button type="button" class="btn btn-primary ng-click-active" style="float: right;margin-left: 10px;" data-toggle="modal" data-target="#showFilterModal" ng-click="procName('proc_cc_presales_completed',5)">
                    ...
                    <table class="table table-hover table-striped table-bordered" ng-if="enquiriesLength">
                        <thead>
                            <tr>
                                ...
                                <th class="enq-table-th">Vehicle / Source</th> 
