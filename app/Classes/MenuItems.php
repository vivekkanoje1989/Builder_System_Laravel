                ...
                'submenu_ids' => '0401,0402,0403,0404', 'anchorClass' => 'menu-dropdown', 'submenuClass' => 'submenu', 'liClass' => 'open', 'submenu' => array(
                    1 => array('id' => '0401', 'name' => 'Enquiry Management', 'icon' => '', 'ui-sref-active' => '', 'slug' => '#', 'has_submenu' => true, 'total_submenu' => 9,
                        ...
                        9 => array('id' => '040109', 'name' => 'Team\'s Enquiries', 'icon' => '', 'ui-sref-active' => '', 'slug' => '#', 'has_submenu' => true, 'total_submenu' => 6,
                            ...
                            2 => array('id' => '04010902', 'name' => 'Pending Followups', 'icon' => '', 'url' => '/'.$getUrl.'/sales/teampendingfollowups', 'slug' => '.teampendingfollowups', 'uiSrefActive' => 'active', 'total_submenu' => 1),
                            3 => array('id' => '04010903', 'name' => 'Previous Followups', 'icon' => '', 'url' => '/'.$getUrl.'/sales/teampreviousfollowups', 'slug' => '.teampreviousfollowups', 'uiSrefActive' => 'active', 'total_submenu' => 1),
                            4 => array('id' => '04010904', 'name' => 'Total Enquiries', 'icon' => '', 'url' => '/'.$getUrl.'/sales/teamtotalenquiries', 'slug' => '.teamtotalenquiries', 'uiSrefActive' => 'active', 'total_submenu' => 1),
                            5 => array('id' => '04010905', 'name' => 'Lost Enquiries', 'icon' => '', 'url' => '/'.$getUrl.'/sales/teamlostenquiries', 'slug' => '.teamlostenquiries', 'uiSrefActive' => 'active', 'total_submenu' => 1),
                            6 => array('id' => '04010906', 'name' => 'Closed Enquiries', 'icon' => '', 'url' => '/'.$getUrl.'/sales/teamclosedenquiries', 'slug' => '.teamclosedenquiries', 'uiSrefActive' => 'active', 'total_submenu' => 1),
                        )),
                    )),
