                ...
                <div class="row">
                    <div class="col-sm-5 col-xs-12" style="float:left">
                        ...
                        <div class="col-sm-4 center">
                            <button type="button" class="btn btn-primary toggleForm" style="float: right;margin-left: 10px;" data-toggle="modal" data-target="#showFilterModal" ng-click="procName('proc_cc_presales_complete',5)">
