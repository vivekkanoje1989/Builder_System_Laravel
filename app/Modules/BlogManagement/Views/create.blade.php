    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body table-responsive">     
                <form  ng-submit="blogsForm.$valid && doblogscreateAction(bannerImage)" name="blogsForm" >
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                                        <div class="widget flat radius-bordered">
                                                            ...
                                                            <div class="widget-body no-padding">
                                                                <div ng-controller="TextAngularCtrl">
                                                                    <div text-angular ng-model="contentPage" name="demo-editor" ta-text-editor-class="editor-text" ta-html-editor-class="editor-text"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
