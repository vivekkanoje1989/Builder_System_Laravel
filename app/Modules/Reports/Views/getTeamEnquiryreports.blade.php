...
<div class="row">
    <div class="widget flat radius-bordered">
        <div class="col-lg-12 col-sm-12 col-xs-12" ng-controller="reportsController" ng-init="teamEnquiryReport(<?php echo Auth::guard('admin')->user()->id;?>)">
                                    ...
                                    <table class="table table-hover table-striped table-bordered" at-config="config">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="sources in team_source_report">
                                                <td><a href="" ng-click="getsourceReport(sources,$index,<?php echo Auth::guard('admin')->user()->id;?>)">{{sources.name}}</a></div>
                                                <td>{{sources.total}}</td>
                                    ...
                                    <table class="table table-hover table-striped table-bordered" at-config="config">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="status in team_status_report">
                                                <td ng-if="status.is_parent==1 && status.employee_id!=employee_id"><a href="" ng-if="status.is_parent==1 && status.employee_id!=employee_id" ng-click="teamstatusReport(status,$index,<?php echo Auth::guard('admin')->user()->id;?>)">{{status.name}}<i class="icon" style="float: right" ng-class="isSubEmployeeShown ? 'ion-chevron-up' : 'ion-chevron-down'"></i></a></div>
