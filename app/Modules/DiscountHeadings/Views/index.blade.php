...
<!--                        <a class="btn btn-default DTTT_button_print" id="ToolTables_editabledatatable_1" title="View Excel" ng-click="discountHeadingExportToxls()" ng-show="exportData == '1'">
                        ...
                        <a class="btn btn-default DTTT_button_collection" id="ToolTables_editabledatatable_2">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                <li>
                                    <a href="" ng-click="discountHeadingExportToxls()" ng-show="exportData == '1'">Export</a>
                                </li>
                            </ul>
                        </a>
                    </div>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="list in DiscountHeadingRow| filter:search | filter:searchData | itemsPerPage:itemsPerPage| orderBy:sortKey:reverseSort" >
                                ...
                                <td class="">
                                    <span class="" tooltip-html-unsafe="Edit discount heading"  data-toggle="modal" data-target="#discountheadingModal"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{ list.discount_name}}',{{ list.status}},{{itemsPerPage}},{{$index}})" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a></span>
