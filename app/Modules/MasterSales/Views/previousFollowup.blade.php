                ...
                <div  class="widget-body table-responsive">
                    <div class="row table-toolbar">
                        ...
                        <div class="btn-group pull-right filterBtn">
                            <a class="btn btn-default toggleForm" ng-click="procName('proc_get_previous_followups', '', sharedemployee)" ng-if="enquiriesLength != 0"><i class="btn-label fa fa-filter"></i>Show Filter</a>
                        </div>
                    </div>
                                    ...
                                    <td width="20%">
                                        ...
                                        <div>
                                            <p ng-if="[[ Auth::guard('admin') -> user() -> customer_contact_numbers]] == 0 && enquiry.mobile != ''"> 
                                                <span  ng-if="displayMobile == '1'" class="text">+91-xxxxxx{{enquiry.mobile.substring(enquiry.mobile.length - 4, enquiry.mobile_number.length)}}</span>
                                                <span  ng-if="displayMobile != '1'" class="text">{{enquiry.mobile}}</span>
                                            </p>
                        ...
                        <div class="DTTTFooter">
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginate">
                                    <dir-pagination-controls class="pagination" on-page-change="pageChanged(newPageNumber,'previousFollowups','', [[$type]], newPageNumber,listType,sharedemployee)" max-size="5" direction-links="true" boundary-links="true" ng-if="enquiriesLength"></dir-pagination-controls>
                                </div>
                            </div>
                        </div>
