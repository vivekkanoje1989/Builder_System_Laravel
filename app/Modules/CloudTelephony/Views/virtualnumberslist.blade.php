    ...
    <div class="col-xs-12 col-md-12 mainDiv">
        <div class="widget flat radius-bordered">
            <div class="widget-header bordered-bottom bordered-themeprimary">
                ...
                <span class="helpDescription" ng-mouseover="showHelpVirtualNumbers()">Help?</span> 
            </div>
                        ...
                        <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                            ...
                            <tbody>
                                <tr role="row" dir-paginate="listNumber in listNumbers | filter:search | filter:searchData | itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort" >
                                    ...
                                    <td class="">
                                        <span class="" tooltip-html-unsafe="Edit" ><a href="[[ config('global.backendUrl') ]]#/virtualnumber/update/{{ listNumber.id}}" class="btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a></span>
