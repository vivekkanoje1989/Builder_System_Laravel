                    ...
                    <link rel="stylesheet" href="/frontend/common/assets/bootstrap.min.css">
                        <link rel="stylesheet" href="/frontend/common/assets/jquery-ui.css">
                            <link rel="stylesheet" href="/frontend/common/assets/intlTelInput.css">
                                ...
                                <body class="regbg">
                                    <?php
                                    $client = json_decode($GLOBALS['client_info'], true);
                                    ?>
                                    <div class="container">
                                        <div class="well col-md-12 col-sm-12 col-xs-12 mar50" align="center">
                                            <div class="col-md-2 col-sm-3 col-xs-12"> 
                                                <div class="col-md-2 col-sm-3 col-xs-12"><img src="<?php echo config('global.s3Path') . '/client/' . config('global.client_id') . '/' . $client['company_logo']; ?>" class="logo"></div></div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-4 form-group">
                                                                    ...
                                                                    <input type="text" ng-model="userData.office_email_id"  placeholder="Mobile Number" name="office_email_id" class="form-control" ng-pattern="/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/" maxlength="45" >
                                                                        <i class="fa fa-envelope"></i>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea rows="3" class="form-control" ng-model="userData.current_address" name="current_address" class="form-control" maxlength="250" required></textarea>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Address <span class="error_msg">*</span></label>
                                                                <textarea rows="3" class="form-control" ng-model="userData.permenent_address" name="permenent_address" class="form-control" maxlength="250" required></textarea>
                                                            ...
                                                            <br>
                                                                <button type="submit" class="btn btn-lg btn-info" ng-click="sbtBtn = true">Submit</button>
                                                        </div>
                                                    </form> 
                                                </div>
