...
class S3 {
    ...
    public static function SaveImageStorage($filename, $folderName) {
        ...
        if ($position > 0) {
            ...
            if ($MainFolderCount == '0') {
                ...
                $res = MyStorage::create($newFolder);
            }
            ...
            if ($count == 0) {
                ...
                $subFolders = MyStorage::where('folder', '=', $MainFolder)->update(['sub_folder' => $sub_folder]);
            }
