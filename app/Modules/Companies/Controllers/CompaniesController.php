...
//                        }
                        ...
                        array_push($post, ["estimate_letterhead_file" => $input['stationary'][$i]['estimate_letterhead_file']]);
                    }
                } else {
                    $input['stationary'][$i]['estimate_letterhead_file'] = '';
                }
...
//                        }
                        ...
                        array_push($post, ["estimate_logo_file" => $input['stationary'][$i]['estimate_logo_file']]);
                    }
                } else {
                    $input['stationary'][$i]['estimate_logo_file'] = '';
                }
//
//
...
//                        } 
                        ...
                        array_push($post, ["demandletter_letterhead_file" => $input['stationary'][$i]['demandletter_letterhead_file']]);
                    }
                } else {
                    $input['stationary'][$i]['demandletter_letterhead_file'] = '';
                }
//
//
                if (!empty($input['stationary'][$i]['demandletter_logo_file'])) {
                    ...
                    if ($docFile == '1') {
                        ...
                        array_push($post, ["demandletter_logo_file" => $input['stationary'][$i]['demandletter_logo_file']]);
                    }
                } else {
                    $input['stationary'][$i]['demandletter_logo_file'] = '';
                }
//
                if (!empty($input['stationary'][$i]['receipt_logo_file'])) {
                    ...
                    if ($docFile == '1') {
                        ...
                        array_push($post, ["receipt_logo_file" => $input['stationary'][$i]['receipt_logo_file']]);
                    }
                } else {
                    $input['stationary'][$i]['receipt_logo_file'] = '';
                }
//
                if (!empty($input['stationary'][$i]['receipt_letterhead_file'])) {
                    ...
                    if ($docFile == '1') {
                        ...
                        array_push($post, ["receipt_letterhead_file" => $input['stationary'][$i]['receipt_letterhead_file']]);
                    }
                } else {
                    $input['stationary'][$i]['receipt_letterhead_file'] = '';
                }
                if (!empty($input['stationary'][$i]['rubber_stamp_file'])) {
                    ...
                    if ($docFile == '1') {
                        ...
                        array_push($post, ["rubber_stamp_file" => $input['stationary'][$i]['rubber_stamp_file']]);
                    }
                } else {
                    $input['stationary'][$i]['rubber_stamp_file'] = '';
                }
    ...
    public function updateDocuments() {
        ...
        for ($i = 0; $i < count($input['documents']); $i++) {
            ...
            if (!empty($input['documents'][$i]['document_file'])) {
                ...
                $input['documents'][$i]['documentFile'] = '';
            }
