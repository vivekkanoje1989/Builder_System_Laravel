        ...
        <div class="widget flat radius-bordered">
            ...
            <div class="widget-body table-responsive" >
                <div class="row table-toolbar">
                    ...
                    <div class="btn-group pull-right filterBtn" ng-if="enquiriesLength != 0">
                ...
                <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    ...
                    <div class="dataTables_length" ng-if="enquiriesLength != 0">
                        <label>
                            <select class="form-control" ng-model="itemsPerPage" name="itemsPerPage" ng-change="noOfrecords(pageNumber,itemsPerPage,'todaysFollowups','', [[$type]],newPageNumber,listType,sharedemployee)">
                ...
                <table class="table table-hover table-striped table-bordered tableHeader" at-config="config" >
                    ...
                    <td width="20%">
                        ...
                        <hr class="enq-hr-line">
                        <div>
                            <a href data-toggle="modal" data-target="#todayremarkDataModal" ng-click="getTodayRemark({{enquiry.id}},'',sharedemployee)"><i class="fa fa-external-link" aria-hidden="true"></i>&nbsp;Today's Remark</a><br/>
