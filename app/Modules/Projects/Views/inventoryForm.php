            ...
            <div class="col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="col-sm-3 col-sx-6">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            <input type="text" class="form-control" placeholder="Show Label On Website" ng-model="inventoryData.block_sub_type_label" name="block_sub_type_label" required ng-show="inventoryData.block_sub_type_label = (inventoryData.block_sub_type_label == 1 ? true : false);">
