            ...
            <div class="col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="col-sm-3 col-sx-6">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            <input type="text" class="form-control" placeholder="Show On Website" ng-model="inventoryData.block_sub_type_label" name="block_sub_type_label" required>
                ...
                <div class="col-sm-3 col-sx-6">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            <label>
                                <input class="checkbox-slider slider-icon colored-primary" type="checkbox" ng-model="inventoryData.block_availablity" name="block_availablity">
            ...
            <div class="col-lg-12 col-sm-12 col-xs-12">
                <div class="col-sm-3 col-sx-6">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            ...
                            <div ng-show="sbtBtn" ng-messages="inventoryInfoForm.sellable_area_in_sqft.$error" class="help-block" maxlength="10" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                ...
                <div class="col-sm-3 col-sx-6">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            <input type="text" class="form-control" ng-model="inventoryData.sellable_area_in_sqmtr" name="sellable_area_in_sqmtr" required maxlength="10" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                            <i class="fa fa-pencil"></i>
                ...
                <div class="col-sm-3 col-sx-6">
                    <div class="form-group">
                        ...
                        <span class="input-icon icon-right">
                            <label>
                                <input class="checkbox-slider slider-icon colored-primary" type="checkbox" ng-model="inventoryData.show_on_website" name="show_on_website">
                        ...
                        <div class="">
                            <div class="col-sm-4 col-sx-6">
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right"> 
                                        <input type="text" class="form-control" ng-model="otherData.other_label" name="other_label" capitalizeFirst oninput="if (/[^A-Za-z ]/g.test(this.value)) this.value = this.value.replace(/[^A-Za-z ]/g,'')">
                                        <i class="fa fa-align-justify"></i>
                                    </span>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        <input type="text" class="form-control" ng-model="otherData.area_in_sqft" name="area_in_sqft" maxlength="10" oninput="if (/[^0-9.]/g.test(this.value)) this.value = this.value.replace(/[^0-9.]/g,'')"
                                               ng-change="otherData.area_in_sqmtr = (otherData.area_in_sqft*0.092903).toFixed(3)">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="input-icon icon-right">
                                        ...
                                        <input type="text" class="form-control"  ng-model="otherData.area_in_sqmtr" name="area_in_sqmtr" maxlength="10" oninput="if (/[^0-9.]/g.test(this.value)) this.value = this.value.replace(/[^0-9.]/g,'')"
                                               ng-change="otherData.area_in_sqft = (otherData.area_in_sqft ==null || otherData.area_in_sqft == '') ? (otherData.area_in_sqmtr/0.092903).toFixed(3) : otherData.area_in_sqft" >
                                        <i class="fa fa-times"></i>
                                    </span>                                    
                                </div>
                            </div>
                            <div class="col-sm-2 col-sx-6">
                                <div class="form-group">
                                    <label for="">Show On Web<span class="sp-err">*</span></label>
                                    <span class="input-icon icon-right">
                                        <label>
                                            <input class="checkbox-slider slider-icon colored-primary" type="checkbox" ng-model="otherData.show_on_website" checked="" name="show_on_website">
                            ...
                            <div class="col-sm-2 col-sx-6">
                                <div class="form-group">
                                    <label for=""></label>
                                    <span class="input-icon icon-right">
                                        <button class="btn btn-primary btn-xs" ng-if="$last" ng-click="addNewData()">Add</button>
                                        <button class="btn btn-primary btn-xs" ng-if="!$first" ng-click="removeRow($index)">Remove</button>                                        
                                    </span>
                                </div>
                            </div>
                        </div> 
