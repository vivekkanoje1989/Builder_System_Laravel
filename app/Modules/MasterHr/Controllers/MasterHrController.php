...
//        }
    ...
    public function getRoles() {
        ...
        if (!empty($roles)) {
            $result = ['success' => true, 'exportDetails' => $export, "list" => $roles, 'totalCount' => $cnt];
        } else {
...
//            $parentId = $submenuId = array();
    ...
    public function getTeamLeadForQuick() {
        ...
        $employee = Employee::with('designationName')->select("id", "first_name", "last_name", 'designation_id', 'personal_mobile1', 'personal_email1', 'office_mobile_no', 'office_email_id', 'employee_id')->where(["employee_status" => 1])->orderBy("first_name", "ASC")->get();
