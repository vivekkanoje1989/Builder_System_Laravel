...
<div class="row" ng-controller="enquiryController" ng-init="lostEnquiries('', [[$type]], 1, [[config('global.recordsPerPage')]], 7, ''); getAllEmployeeData();" >
    <div class="firstDiv">
                ...
                <div class="widget-body table-responsive"> 
                    <div class="row table-toolbar">
                        ...
                        <div class="btn-group pull-right filterBtn">
                            <a ng-if="enquiriesLength != 0" class="btn btn-default toggleForm" ng-click="procName('proc_get_lost_enquiries', '', sharedemployee)"><i class="btn-label fa fa-filter"></i>Show Filter</a>
                        </div>
                    </div>
                    <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                            ...
                            <b ng-repeat="(key, value) in showFilterData" ng-if="key != 'toDate'">                         
                                <div class="col-sm-2" data-toggle="tooltip" title="{{  key.substring(0, key.indexOf('_'))}}" ng-if="value != ''" >
                                    <div class="alert alert-info fade in">
                                        ...
                                        <strong ng-if="key === 'channel_id' || key === 'city_id' || key === 'lostReason_id' || key === 'category_id' || key === 'source_id' || key == 'status_id'"><strong>{{  key.substring(0, key.indexOf('_'))}} : </strong>{{  value.substring(value.indexOf("_") + 1)}}</strong>
                                        ...
                                        <strong ng-if="key === 'subreason_id'" ng-repeat='subreason in value track by $index'> {{ $index + 1}}){{   subreason.sub_reason}}</strong>
                        ...
                        <div class="dataTables_length" >
                            <label>
                                <select class="form-control" ng-model="itemsPerPage" ng-disabled="disableBtn" name="itemsPerPage" ng-change="noOfrecords(pageNumber, itemsPerPage, 'lostEnquiries', '', [[$type]], newPageNumber, listType, sharedemployee)">
                                ...
                                <div ng-init="mobile_list = enquiry.mobile.split(',')">
                                    ...
                                    <p  ng-if="<?php echo Auth::guard('admin')->user()->customer_email; ?> == 1 && enquiry.email != '' && enquiry.email != 'null'" ng-init="all_email_list = enquiry.email.split(',');" >
                                        ...
                                        <span ng-repeat="emailobj in all_email_list| limitTo:2">
                                            <span class="text" ng-click="manageEmailText(key, value)" ng-if="value != 'null' && displayEmail != '1'">{{emailobj}}</span>
                                            <span class="text" ng-click="manageEmailText(key, value)" ng-if="value != 'null' && displayEmail == '1'">{{ emailobj | emailHider }}</span>
                                            <span ng-if="$index == 0 && all_email_list.length >= 2 && emailobj != 'null'">/</span>                                              
                                        </span>                                        
                                    </p>
                                </div>
                        ...
                        <div class="DTTTFooter">
                            ...
                            <div class="col-sm-6">
                                <div class="dataTables_paginate paging_bootstrap" id="DataTables_Table_0_paginate">
                                    <dir-pagination-controls class="pagination" on-page-change="pageChanged(newPageNumber,'lostEnquiries','', [[$type]], newPageNumber,listType,sharedemployee)" max-size="5" direction-links="true" boundary-links="true" ng-if="enquiriesLength"></dir-pagination-controls>
                                </div>
                            </div>
                        </div>                
                    </div>
