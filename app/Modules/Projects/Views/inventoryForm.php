...
<div class="modal-body">
    <form role="form" name="inventoryInfoForm" id="inventoryInfoForm" novalidate ng-submit="inventoryInfoForm.$valid && getInventoryDetails(projectData.prid, inventoryData.wing_id, inventoryData, otherDataMultiple)" novalidate>
