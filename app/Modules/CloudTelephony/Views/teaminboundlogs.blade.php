    ...
    <div class="col-xs-12 col-md-12 mainDiv">
        <div class="widget flat radius-bordered">
            <div class="widget-header bordered-bottom bordered-themeprimary">
                ...
                <span class="helpDescription" ng-mouseover="showHelpTeamInboundCall()">Help?</span> 
            </div>
...
<!--                        <a class="btn btn-default DTTT_button_print" id="ToolTables_editabledatatable_1" title="View Excel" ng-click="teamInboundExportToxls()" ng-show="teaminboundExport == '1'">
                            <span>Export</span>
                        </a>-->
