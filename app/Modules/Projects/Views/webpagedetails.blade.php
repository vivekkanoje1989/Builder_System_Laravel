        ...
        <div class="row">
            <div class="col-lg-12 col-sm-6 col-xs-12">
                ...
                <tabset>
                    ...
                    <tab heading="Uploads" class="uploadsTab" disabled="showAllTabs" ng-click="uploads([[ $projectId ]],'')">
                        <div data-ng-include=" '/projects/uploads' "></div>
                    </tab>
                    <tab heading="Project Inventory" ng-click="getProjectInventory(0)" disabled="showAllTabs">
