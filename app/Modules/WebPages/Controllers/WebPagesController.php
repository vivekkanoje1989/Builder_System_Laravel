...
//
    ...
    public function storeSubWebPage() {
        ...
        if (!empty($input['subcontentPages']['subpage_name'])) {
            $input['subcontentPages']['page_name'] = $input['subcontentPages']['subpage_name'];
        }else{
            $input['subcontentPages']['page_name'] ='';
        }
    ...
    public function updateSubWebPage() {
        ...
        $input = Input::all();
        $subPages = array();
        if (!empty($input['subcontentPage']['id'])) {
            $input['subcontentPage']['id'] = $input['subcontentPage']['id'];
        }else{
            $input['subcontentPage']['id'] ='';
        }
        if (!empty($input['subcontentPage']['subpage_name'])) {
            $input['subcontentPage']['page_name'] = $input['subcontentPage']['subpage_name'];
        }else{
            $input['subcontentPage']['page_name'] ='';
        }
        if (!empty($input['subcontentPage']['subpage_title'])) {
            $input['subcontentPage']['page_title'] = $input['subcontentPage']['subpage_title'];
        }else{
            $input['subcontentPage']['page_title'] ='';
        }
