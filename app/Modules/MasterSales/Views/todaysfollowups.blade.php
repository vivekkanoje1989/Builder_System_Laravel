...
<div class="row" ng-controller="enquiryController" ng-init="todaysFollowups('', [[$type]],1, [[config('global.recordsPerPage')]],1)" >
                ...
                <div class="row">
                    <div class="col-sm-2 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" minlength="1" maxlength="3" ng-change="todaysFollowups('', [[$type]],{{pageNumber}}, itemsPerPage,1)" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" style="width:45%;" class="form-control" ng-model="itemsPerPage">
                        </div>
                    </div>
                    <div class="col-md-5 col-xs-12">
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">                                
                                <button type="button" class="btn btn-primary btn-right toggleForm" style="margin-left: 5px;"  ng-click="procName('proc_get_today_followups')"><i class="btn-label fa fa-filter"></i>Show Filter</button>
                    ...
                    <div class="col-sm-5 col-xs-12" ng-if="enquiriesLength != 0">
                        <div class="form-group">
                            ...
                            <span class="input-icon icon-right">
                                ...
                                <dir-pagination-controls max-size="5"  class="pull-right pagination" on-page-change="pageChanged(newPageNumber,'todaysFollowups','', [[$type]],newPageNumber,listType)" template-url="/dirPagination" ng-if="enquiriesLength"></dir-pagination-controls>                            
                            </span>
                        </div>
                    </div>
                </div>                
                        ...
                        <tr dir-paginate="enquiry in  enquiries | filter:search | itemsPerPage: itemsPerPage | orderBy:orderByField:reverseSort" total-items="{{ enquiriesLength}}">
                            ...
                            <td width="20%">
                                ...
                                <div ng-if="[[Auth::guard('admin')->user()->customer_contact_numbers]] == 1 && enquiry.mobile !=''" ng-init="mobile_list=enquiry.mobile.split(',')">  
                                    ...
                                    <a ng-if="displayCallBtn == '1'" style="cursor: pointer;" class="Linkhref"
                                       ...
                                       <span  ng-if="MobileNopermissions != '1'" class="text">+91-xxxxxx{{  mobile_obj.substring(mobile_obj.length - 4, mobile_obj.length)}}</span>
                                        <span  ng-show="MobileNopermissions =='1'" class="text">{{mobile_obj}}</span>
                                ...
                                <div ng-init="mobile_list=enquiry.mobile.split(',')">
                                    ...
                                    <p ng-if="Emailpermissions == '1'" ng-if="<?php echo Auth::guard('admin')->user()->customer_email; ?> == 1 && enquiry.email != '' && enquiry.email != 'null' " ng-init="all_email_list=enquiry.email.split(',');" >
