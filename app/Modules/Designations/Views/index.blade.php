...
<div class="row" ng-controller="designationsCtrl" ng-init="manageDesignations()">  
            ...
            <div class="widget-body table-responsive">
                ...
                <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <div class="DTTT btn-group">
                        <a class="btn btn-default DTTT_button_print" id="ToolTables_editabledatatable_1" title="View Excel" ng-click="designationExportToxls()" ng-show="exportData=='1'">
                            <span>Export</span>
                        </a>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="list in designationsRow  | filter:search |filter:searchData |orderBy:orderByField:reverseSort|itemsPerPage:itemsPerPage" >
                                ...
                                <td class="">
                                    <div class="" tooltip-html-unsafe="Edit designation" style="display: block;" data-toggle="modal" data-target="#designations"><a href="javascript:void(0);" ng-click="initialModal({{ list.id}},'{{list.designation}}','{{list.status}}',{{itemsPerPage}},{{$index}})" class="btn-info btn-xs"><i class="fa fa-edit"></i>Edit</a></div>
                                </td> 
                            </tr>
                        </tbody>
                    </table>
    ...
    <!-- Modal -->
    <div class="modal fade modal-primary" id="designations" role="dialog" tabindex="-1">    
