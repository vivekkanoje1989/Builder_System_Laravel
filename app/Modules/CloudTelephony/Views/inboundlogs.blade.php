        ...
        <div class="widget flat radius-bordered">
            ...
            <div class="widget-body table-responsive">
                ...
                <div role="grid" id="editabledatatable_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <div class="DTTT btn-group"><a class="btn btn-default DTTT_button_collection" id="ToolTables_editabledatatable_2" ng-disabled="disableBtn">
                            <span>Actions</span>
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                <li>
                                    <a href="" ng-click="myInboundExportToxls()" ng-show="myInboundExport == '1'">Export</a>
                                </li>
                            </ul>
                        </a>
                    </div>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr dir-paginate="inbound in inboundList | filter:search| filter:searchData | itemsPerPage: itemsPerPage | orderBy:sortKey:reverseSort" >
