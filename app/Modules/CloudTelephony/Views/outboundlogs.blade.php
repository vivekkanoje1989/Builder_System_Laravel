    ...
    <div class="col-xs-12 col-md-12 mainDiv">
        <div class="widget flat radius-bordered">
            <div class="widget-header bordered-bottom bordered-themeprimary">
                <span class="widget-caption">My Outgoing Call Logs</span>
                <span class="helpDescription" ng-mouseover="showHelpOutboundCall()">Help?</span>
            </div>
...
<!--                        <a class="btn btn-default DTTT_button_print" id="ToolTables_editabledatatable_1" title="View Excel" ng-click="myOutboundExportToxls()" ng-show="myOutboundExport == '1'">
                        ...
                        <a class="btn btn-default DTTT_button_collection" id="ToolTables_editabledatatable_2">
                            ...
                            <ul class="dropdown-menu dropdown-default">
                                <li>
                                    <a href="" ng-click="myOutboundExportToxls()" ng-show="myOutboundExport == '1'">Export</a>
                                </li>
                            </ul>
                        </a>
                    </div>
