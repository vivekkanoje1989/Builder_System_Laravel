    ...
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            <div class="widget-header ">
                ...
                <button confirmed-click="deleteFolder('<?php echo $folderId; ?>',1);" ng-confirm-click="Are you sure delete folder?" class="btn btn-info">Delete Folder</button>
                    ...
                    <div class="col-md-2" ng-repeat="imgs in folderImages track by $index | unique:'imgs' " style="margin:0 0 25px 0;">
                        <div class="img-wrap"> 
                            ...
                            <a href="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/{{imgs.file_url}}" target="_blank">      
                                <img src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/{{imgs.file_url}}" height="100px;" width="100px;"></a>
                        </div>
                    </div>
                </div>
