                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        <thead class="bord-bot">
                            <tr>
                                ...
                                <th style="width:10%">
                                    <a href="javascript:void(0);" ng-click="orderByField('credits_deducted')">Credit Deducted
                        ...
                        <tbody>
                            ...
                            <tr role="row" dir-paginate="listSms in smslogslistdetail | filter:search |filter:searchData| itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort" >
                                ...
                                <td ng-show="{{listSms.bulk_file_id.length}}!== 0">
                                    ...
                                    <a href="[[config('global.s3Path')]]bulk_sms_file/{{listSms.bulk_file_id}}" class="btn btn-primary btn-xs"><i class="fa fa-download" aria-hidden="true"></i>Download</a>
                            ...
                            <tr>
                                <td colspan="9"  ng-show="(smslogslistdetail|filter:search | filter:searchData).length == 0" align="center">Record Not Found</td>   
                            </tr>
                        </tbody>
                    </table><br>
