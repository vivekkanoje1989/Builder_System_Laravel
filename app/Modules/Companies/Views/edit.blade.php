            ...
            <div class="widget-body table-responsive">     
                <form  ng-submit="companysForm.$valid && docompanyscreateAction(CompanyData.firm_logo, CompanyData)" name="companysForm"  novalidate enctype="multipart/form-data">
                    ...
                    <table class="table table-hover table-striped table-bordered" at-config="config">    
                        ...
                        <tr  data-ng-repeat="document in documents"><td width="10%">{{$index + 1}}</td>
                            <td width="30%">
                                <input type="text"   ng-model="document.document_name" name="document_name" id="document_name"  class="form-control imageFile" >
                            </td>
                            <td width="10%">
                                <div><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/documents/{{document.documentFile}}"  height="80px" width="80px" ></div>
                                <br/>
                                <input type="hidden"   ng-model="document.documentFile" >
                    ...
                    <table class="table table-hover table-striped table-bordered"  data-ng-repeat="stationary in Stationary">
                        ...
                        <tbody>
                            <tr >
                                ...
                                <td width="30%">
                                    <input type="hidden"   ng-model="stationary.estimateLetterheadFile" >
                                    <div ng-if="stationary.estimateLetterheadFile"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/estimateLetterhead/{{stationary.estimateLetter}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
                                ...
                                <td width="20%">
                                    <input type="hidden"   ng-model="stationary.receiptLetterhead" >
                                    <div ng-if="stationary.receiptLetterhead"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/receiptLetterhead/{{stationary.receiptLetterhead}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
                                ...
                                <td width="20%">
                                    <input type="hidden"   ng-model="stationary.rubberStamp" >
                                    <div ng-if="stationary.rubberStamp"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/rubberStampFile/{{stationary.rubberStamp}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
                            ...
                            <tr>
                                <td width="10%"></td>
                                <td width="20%">
                                    <input type="hidden"   ng-model="stationary.estimateLogo" >
                                    <div ng-if="stationary.estimateLogo"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/estimateLogoFile/{{stationary.estimateLogo}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
                                ...
                                <td width="30%">
                                    <input type="hidden"   ng-model="stationary.demandletterFile" >
                                    <div ng-if="stationary.demandletterFile"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/demandletterFile/{{stationary.demandletterFile}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
                                ...
                                <td width="20%">
                                    <input type="hidden"   ng-model="stationary.demandletterLogoFile" >
                                    <div ng-if="stationary.demandletterLogoFile"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/demandletterLogoFile/{{stationary.demandletterLogoFile}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
                                ...
                                <td width="20%">
                                    <input type="hidden"   ng-model="stationary.receiptLogoFile" >
                                    <div ng-if="stationary.receiptLogoFile"><img ng-src="https://s3.ap-south-1.amazonaws.com/bmsbuilderv2/Company/receiptLogoFile/{{stationary.receiptLogoFile}}"  height="80px" width="80px" ></div>
                                    <span class="input-icon icon-right">
