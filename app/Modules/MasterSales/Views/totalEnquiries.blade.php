...
<!--                        <span ng-if="enquiry.location_name != null && enquiry.location_name != '' " data-toggle="tooltip" title="{{enquiry.location_name}}">                                    
                    ...
                    <td width="20%">
                        ...
                        <div>
                            ...
                            <a href ng-if="enquiry.email != '' && enquiry.email != 'null'" data-toggle="modal" data-target="#sendDocumentDataModal" ng-click="sendDocuments({{enquiry.id}})"><i class="fa fa-external-link" aria-hidden="true"></i>&nbsp;{{enquiry.email}}Send Documents</a><br/>
