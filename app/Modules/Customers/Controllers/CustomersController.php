...
//        print_R($result);
    ...
    public function update() {
        ...
        $marriageDate = $input['marriage_date'];
        ...
        unset($input['marriage_date']);
        unset($input['birth_date']);
        $input['birth_date'] = date('Y-m-d', strtotime($birthDate));
        $input['marriage_date'] = date('Y-m-d', strtotime($marriageDate));
