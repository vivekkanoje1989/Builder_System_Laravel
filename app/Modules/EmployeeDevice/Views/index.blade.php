    ...
    <div class=" mainDiv col-xs-12 col-md-12">
        <div class="widget flat radius-bordered">
            <div class="widget-header bordered-bottom bordered-themeprimary">
                ...
                <span class="helpDescription" ng-mouseover="showHelpEmployeeDevice()">Help?</span>                     
            </div>
                    ...
                    <table class="table table-hover table-striped table-bordered tableHeader" at-config="config">
                        ...
                        <tbody>
                            <tr role="row" dir-paginate="listDevice in listDevices | filter:search |filter:searchData | itemsPerPage:itemsPerPage | orderBy:sortKey:reverseSort">
                                ...
                                <td class="">
                                    <span class="" tooltip-html-unsafe="Edit Information" ><a href="[[ config('global.backendUrl') ]]#/employeeDevice/update/{{ listDevice.id}}" class="btn-primary btn-xs"><i class="fa fa-edit"></i>Edit</a> &nbsp;&nbsp;</span>                               
